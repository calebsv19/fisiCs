...
static int expect_u64(osp2_u64 actual, osp2_u64 expected) {
...
int main(void) {
    ...
    if (failures != 0) {
        puts("OS-P2 case=osp2_storage_admission vectors=18 result=FAIL");
        return 1;
    }
    puts("OS-P2 case=osp2_storage_admission vectors=18 result=PASS");
    return 0;
}
