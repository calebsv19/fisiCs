 ...
 * edu-36-bounded-checkpoint-resume-policy, commit
 * d0e429b02223884309d2cdaac9d8070d64b0f8c3.
 * Origin SHA-256: a9221eab3ce57bdd4516429b82fb15690d7be37350489bdbc1841cd2cfac9b1d.
 * The extracted typedefs, constants, helpers, and validator below are
...
enum {
    ...
    EDU36_FLAG_RESUMED = 4,
    EDU36_FLAGS_ALLOWED = 7,
    EDU15_OK = 0,
    EDU15_ERR_FORMAT = 1,
    EDU15_ERR_RESOURCE = 2,
    EDU15_CANCEL = 3,
    EDU36_META_VERSION = 10,
    EDU36_ENTRY_VERSION = 8,
    EDU36_TRACE_VERSION = 3,
    ...
    EDU36_EVENT_RESUME_RESTORED = 19,
...
edu15_u64 edu22_queue_entry_valid(const edu15_u8* p) {
    ...
    if (read64(p) != 0x00004A3531554445ULL ||
        read32(p + 8) != EDU36_ENTRY_VERSION ||
    ...
    flags = read32(p + 28);
    if ((flags & ~EDU36_FLAGS_ALLOWED) != 0) {
        return EDU15_ERR_FORMAT;
    }
    if (read64(p + 40) == 0 ||
        read64(p + 48) != 0x1E3C373BAF48FAF7ULL) return EDU15_ERR_FORMAT;
    if (read16(p + EDU22_TRACE_HEADER) != EDU36_TRACE_VERSION ||
    ...
    for (index = 0; index < count; index = index + 1) {
        ...
        if (sequence <= previous_sequence || kind == 0 ||
            kind > EDU36_EVENT_RESUME_RESTORED || kind == 8 || kind == 9 ||
        ...
        if (kind == EDU36_EVENT_RESUME_RESTORED) {
            if (phase_stage != 0 || read32(event + 16) != EDU15_STATE_RUNNING ||
                read32(event + 20) != 3 || read64(event + 24) == 0) {
                return EDU15_ERR_FORMAT;
            }
            phase_stage = 3;
            resume_value = read64(event + 24);
        }
    }
    ...
    if (state == EDU15_STATE_RUNNING && count != 0) {
        if (last_kind != EDU22_EVENT_RUNNING_PUBLISHED &&
            ...
            last_kind != EDU36_EVENT_RESUME_RESTORED) {
            return EDU15_ERR_FORMAT;
        }
        if ((last_kind == EDU22_EVENT_RUNNING_PUBLISHED && phase_stage != 0) ||
            ...
            (last_kind == EDU36_EVENT_RESUME_RESTORED && phase_stage != 3) ||
    ...
    if (state == EDU15_STATE_PENDING) {
        if ((flags & EDU36_FLAG_RESUMED) != 0) return EDU15_ERR_FORMAT;
    ...
    if (state == EDU15_STATE_COMPLETE &&
        (requested_work != 4 || effective_work != 4 || consumed_work != 4 ||
         (flags != 0 && flags != EDU36_FLAG_RESUMED) ||
         last_reason != 0)) return EDU15_ERR_FORMAT;
    ...
    if (state == EDU15_STATE_CANCELLED) {
        ...
        if ((seen & (1U << EDU22_EVENT_RUNNING_PUBLISHED)) != 0) {
            if (flags != EDU30_FLAG_CANCEL_RUNNING &&
                flags != (EDU30_FLAG_CANCEL_RUNNING | EDU36_FLAG_RESUMED)) {
                return EDU15_ERR_FORMAT;
            }
            if (
                effective_workers != requested_workers ||
            ...
            return EDU15_ERR_FORMAT;
               ...
               state != EDU15_STATE_PENDING &&
               flags != 0 && flags != EDU36_FLAG_RESUMED) {
        return EDU15_ERR_FORMAT;
    }
    if (((flags & EDU36_FLAG_RESUMED) != 0) !=
        ((seen & (1U << EDU36_EVENT_RESUME_RESTORED)) != 0) ||
        ((flags & EDU36_FLAG_RESUMED) != 0 && resume_value == 0)) {
        return EDU15_ERR_FORMAT;
    }
    if (state == EDU15_STATE_FAILED &&
