...
static long double axis3_w11_leaf(
    long double a0,
    long double a1,
    long double a2,
    long double a3,
...
static long double axis3_w11_stage(
    long double seed,
    unsigned epoch,
    unsigned frontier,
    unsigned replay,
...
int main(void) {
    ...
    for (i = 0; i < 14; ++i) {
        long double x0 = axis3_w11_stage(
            seed,
            epoch,
            frontier,
            replay,
        ...
        long double x1 = axis3_w11_stage(
            seed + x0 * 0.09375L,
        ...
        long double x2 = axis3_w11_stage(
            seed + x1 * 0.0703125L,
