...
int main(void) {
    ...
    (void)tg14_enqueue(18u, &s0, &g0);
    (void)tg14_enqueue(36u, &s1, &g1);
    tg14_force_reuse(s0, 63u);
    (void)tg14_enqueue(54u, &s2, &g2);
    (void)tg14_enqueue(72u, &s3, &g3);
    tg14_force_reuse(s2, 99u);
    (void)tg14_enqueue(90u, &wrap_slot, &wrap_generation);
    tg14_force_reuse(s3, 117u);
