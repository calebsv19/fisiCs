...
int main(void) {
    ...
    rs14_commit(s1, g1, 53u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s2, &g2);
    rs14_commit(s2, g2, 71u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s3, &g3);
    rs14_commit(s3, g3, 89u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s0, &g0);
    rs14_commit(s0, g0, 97u) ? (ok += 1u) : (reject += 1u);
