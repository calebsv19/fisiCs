...
int main(void) {
    ...
    (void)tg14_enqueue(19u, &slot0, &gen0);
    (void)tg14_enqueue(41u, &slot1, &gen1);

    tg14_force_reuse(slot0, 73u);
    tg14_force_reuse(slot0, 91u);
    ...
    if (tg14_accept(slot0, gen0 + 1u, &value)) {
        accepted += 1u;
        digest = (digest * 131u) ^ value;
    } else {
        dropped += 1u;
    ...
    if (tg14_accept(slot0, gen0 + 2u, &value)) {
        accepted += 1u;
        digest = (digest * 131u) ^ value;
    } else {
        dropped += 1u;
