...
struct Axis3W16Hfa axis3_w16_hfa_collect(
    ...
    va_list ap;
    struct Axis3W16Hfa out;
    static const int lane_map[23] = {2, 3, 1, 0, 2, 1, 3, 0, 2, 0, 3, 1, 2, 1, 0, 3, 2, 0, 1, 3, 2, 1, 0};
    int i;

    out.a = seed + (float)(epoch & 63u) * 0.009765625f;
    out.b = seed * 0.7890625f + 0.71875f;
    ...
    out.a += (float)(rotl32(epoch ^ frontier, replay & 31u) & 63u) * 0.0013427734375f;
    ...
    out.d -= (float)((epoch >> 1) & 31u) * 0.00115966796875f;
    return out;
}
