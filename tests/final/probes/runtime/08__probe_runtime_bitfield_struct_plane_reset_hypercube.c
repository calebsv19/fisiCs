...
int main(void) {
    struct Grid grids[2] = {
        [0] = {
            ...
            .cells[0][0][0].mark = 1,
            .cells[0][1][0].bits.b = 9,
            .cells[0][1][0].bits.c = 12,
            .cells[0][1][0].mark = 4,
            .cells[0][1][1].bits.a = 2,
            .cells[0][1][1].bits.e = 1,
            .cells[0][1][1].mark = 6,
            .tail = 3,
        },
        [1] = {
            ...
            .cells[1][1][1].mark = 2,
            .cells[1][0][0].bits.a = 6,
            .cells[1][0][0].bits.d = 4,
            .cells[1][0][0].mark = 8,
            .cells[1][0][1].bits.b = 5,
            .cells[1][0][1].bits.e = 1,
            .cells[1][0][1].mark = 9,
            .tail = 6,
        },
    };
