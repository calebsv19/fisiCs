...
int main(void) {
    (void) bucket10_local_struct_step_a(2, 1);
    (void) bucket10_local_struct_step_b(-1, 3);
    printf("%d %d %d\n",
           bucket10_local_struct_step_a(1, 2),
           bucket10_local_struct_step_b(2, -2),
           bucket10_local_struct_peek_a() + bucket10_local_struct_peek_b());
    return 0;
}
