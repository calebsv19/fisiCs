...
static struct Bucket10HeaderTwinStruct bucket10_private_struct = {2, 4};

int bucket10_internal_header_struct_step_a(int delta_left, int delta_right) {
...
int bucket10_internal_header_struct_peek_a(void) {
    return bucket10_private_struct.left + bucket10_private_struct.right;
}
