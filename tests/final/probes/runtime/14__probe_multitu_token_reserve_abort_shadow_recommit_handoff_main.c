...
int main(void) {
    ...
    rs14_commit(s0, g0, 31u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s1, &g1);
    rs14_commit(s1, g1, 41u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s2, &g2);
    rs14_commit(s2, g2, 47u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s3, &g3);
    rs14_abort(s3, g3) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s0, &g0);
    rs14_abort(s0, g0) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s1, &g1);
    rs14_commit(s1, g1, 59u) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s2, &g2);
    rs14_abort(s2, g2) ? (ok += 1u) : (reject += 1u);

    (void)rs14_reserve(&s3, &g3);
    rs14_commit(s3, g3, 71u) ? (ok += 1u) : (reject += 1u);
    ...
    if (rs14_read(s2, g2 - 1u, &value)) {
        ok += 1u;
        digest = (digest * 173u) ^ value;
    } else {
        reject += 1u;
    }
    if (rs14_read(s2, g2, &value)) {
        ok += 1u;
        digest = (digest * 173u) ^ value;
    } else {
        reject += 1u;
    }
    if (rs14_read(s3, g3 - 1u, &value)) {
        ok += 1u;
        digest = (digest * 173u) ^ value;
    } else {
        reject += 1u;
    }
    if (rs14_read(s3, g3, &value)) {
        ok += 1u;
        digest = (digest * 173u) ^ value;
    } else {
        reject += 1u;
