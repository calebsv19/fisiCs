...
int main(void) {
    ...
    (void)tg14_enqueue(10u, &s0, &g0);
    (void)tg14_enqueue(20u, &s1, &g1);
    (void)tg14_enqueue(30u, &s2, &g2);
    tg14_force_reuse(s1, 71u);
    (void)tg14_enqueue(40u, &s3, &g3);
    (void)tg14_enqueue(50u, &wrap_slot, &wrap_generation);
    tg14_force_reuse(s0, 95u);
    tg14_force_reuse(wrap_slot, 83u);
