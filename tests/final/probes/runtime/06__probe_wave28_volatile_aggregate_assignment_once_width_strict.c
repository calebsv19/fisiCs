...
static volatile Wave28Guarded source = {
    0x11111111u,
    {0xa1u, {101u, 202u, 303u}, 7u},
    0x22222222u
};

static volatile Wave28Guarded target = {
    0x33333333u,
...
static volatile Wave28Payload *select_target(void) {
    ++target_evaluations;
    return &target.payload;
}

static volatile Wave28Payload *select_source(void) {
    ++source_evaluations;
