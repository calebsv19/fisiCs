...
int main(void) {
    ...
    (void)tg14_enqueue(16u, &s0, &g0);
    (void)tg14_enqueue(32u, &s1, &g1);
    (void)tg14_enqueue(48u, &s2, &g2);
    (void)tg14_enqueue(64u, &s3, &g3);
    tg14_force_reuse(s0, 69u);
    (void)tg14_enqueue(80u, &wrap_slot, &wrap_generation);
    tg14_force_reuse(s3, 97u);
    tg14_force_reuse(wrap_slot, 111u);
