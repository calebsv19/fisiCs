...
int main(void) {
    ...
    (void)tg14_enqueue(14u, &s0, &g0);
    (void)tg14_enqueue(28u, &s1, &g1);
    (void)tg14_enqueue(42u, &s2, &g2);
    (void)tg14_enqueue(56u, &s3, &g3);
    tg14_force_reuse(s2, 77u);
    (void)tg14_enqueue(70u, &wrap_slot, &wrap_generation);
    tg14_force_reuse(s1, 91u);
    tg14_force_reuse(wrap_slot, 105u);
