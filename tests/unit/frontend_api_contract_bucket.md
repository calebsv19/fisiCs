...
|---|---|---|
| `frontend_api_contract_metadata` | Validate required contract metadata fields and semver floor (`major=1`, `minor>=5`) | pass |
...
| `frontend_api_contract_units_attachment_lane` | Validate the v1.5 units attachment lane stays null/empty and unadvertised when no valid overlay export is present | pass |
