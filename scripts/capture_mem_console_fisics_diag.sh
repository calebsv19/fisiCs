...
DEFAULT_LAUNCHER="${HOME}/Desktop/fisics_program_binaries/mem_console/fisics/eCho.app/Contents/MacOS/mem-console-launcher"
LAUNCHER="${MEM_CONSOLE_FISICS_LAUNCHER:-$DEFAULT_LAUNCHER}"

LOG_ROOT="${HOME}/Desktop/fisics_program_binaries/logs/mem_console/fisics"
RUNTIME_ROOT="${HOME}/Desktop/fisics_program_binaries/runtime/mem_console"
DEFAULT_RUNTIME_DIR="${RUNTIME_ROOT}/fisics"
...
if [[ ! -x "$LAUNCHER" ]]; then
    ...
    echo "Override with MEM_CONSOLE_FISICS_LAUNCHER=/abs/path/to/mem-console-launcher" >&2
    exit 2
fi
...
echo "=== mem_console fisiCs capture ==="
echo "launcher: $LAUNCHER"
echo "output dir: $OUT_DIR"
echo "Close the app when done reproducing flicker."
