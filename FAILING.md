...
- [FAIL] `/Users/calebsv/Desktop/CodeWork/daw` batch compile (`-c` + `-I.../daw/include` + `-I.../daw/src`) => 160 files: 1 pass / 159 fail. Common issues: missing system headers (`SDL2/SDL.h`), missing project headers (`vk_renderer_sdl.h`), conflicting anonymous struct/enum definitions, and `__func__` undeclared.
