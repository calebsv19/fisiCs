...
typedef enum {
    ...
    // Storage Classes
    TOKEN_EXTERN, TOKEN_STATIC, TOKEN_AUTO, TOKEN_REGISTER, TOKEN_THREAD_LOCAL,

    // Modifiers
    TOKEN_CONST, TOKEN_VOLATILE, TOKEN_RESTRICT, TOKEN_INLINE, TOKEN_ATOMIC, TOKEN_NORETURN,
    TOKEN_COMPLEX, TOKEN_IMAGINARY,

    // Special Values
    TOKEN_NULL, TOKEN_SIZEOF, TOKEN_ALIGNOF, TOKEN_STATIC_ASSERT,

    // ==============================
    //  Identifiers & Literals
    // ==============================
    TOKEN_IDENTIFIER,        // Variable & function names
    TOKEN_INCLUDE, TOKEN_INCLUDE_NEXT, TOKEN_DEFINE, TOKEN_UNDEF,        // Basic preprocessor
